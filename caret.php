        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="cart my-2 my-lg-0 active">
                            <span>
                        ...
                        <div class="product-list">
                            <form method="post">
                                <table class="table">
                                    ...
                                    $val = $conn->query($sql);
                                    While ($row2 = $val->fetch()) {
                                    $book = $row2['book_id'];
                                    $sql2 = "select * from books WHERE id=" . $book;
                                    $val2 = $conn->query($sql2);
                                    While ($row = $val2->fetch()) {
                                    ?>
                                    ...
                                    <tr class="">
                                        <td class="">
                                            <div class="product-info">
                                                <?php
                                                echo "<a href='product-single.php?id=" . $row['id'] . "'><img height=\"120\" width=\"80\" src='img/" . $row['image'] . "' alt='Image' class='img-responsive'></a>";
                                                ?>
                                            </div>
                                        </td>
                                        <?php
                                        echo '<td class="">';
                                        echo " <a href='product-single.php?id=" . $row['id'] . "'>" . $row['title'] . "</a>";
                                        echo '</td>';
                                        echo '<td class="">' . "$" . $row['price'] . '</td>';

                                        ?>
                                        <td class="">
                                            <a type="submit"   href="caret.php?id=<?php echo $row2['id'] ?> " class=" red btn">Remove</a>
                                        </td>
                                        <?php
                                        }
                                        }
